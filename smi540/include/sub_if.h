...
/*
*-------------------------------------------------------------------
* $Id: sub_if.h,v 1.31 2009/07/01 11:58:06 avr32 Exp $
*-------------------------------------------------------------------
*/
...
#define SUB_MAX_I2C_READ  (SUB_MAX_PACK-1-(int)&((sub_tag_t*)(0))->i2c_rdwr_resp.data)
#define SUB_MAX_I2C_WRITE (SUB_MAX_PACK-1-(int)&((sub_tag_t*)(0))->i2c_rdwr_req.ma)
...
#define SUB_MAX_I2C_SCAN (SUB_MAX_PACK-1-(int)&(((sub_tag_t*)(0))->i2c_scan_resp.slave_buf[0]))
...
#define SUB_MAX_SPI_RDWR (SUB_MAX_PACK-1-(int)&(((sub_tag_t*)(0))->spi_rdwr_req.data[0]))
